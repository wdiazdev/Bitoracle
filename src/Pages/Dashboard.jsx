          ...
          <div className="dashboard--wrapper">
            <div className="dashboard--data">
              <div className="user--inputs">
                ...
                <DashChart assets={assets} />
              </div>

              <DashboardAssets balance={balance} assets={assets} setAsset={setAsset} />
            </div>

            <div className="highest--lowest">
              <HighestHolding assets={assets} balance={balance} />

              <LowestHolding assets={assets} balance={balance} />
            </div>
