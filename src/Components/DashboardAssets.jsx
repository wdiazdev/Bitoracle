      ...
      {assets.length > 0 ? (
        <div className="assets--container">
          ...
          >
            ...
            <p className="assets-container--balance">{formatCurrency(balance)}</p>
          </div>
              ...
              return (
                <tbody key={index}>
                  <tr className="asset--table--row">
                    ...
                    <td>
                      <p style={priceChange > 0 ? { color: "#7CFC00" } : { color: "#DC0000" }}>
                    ...
                    <td>
                      <MdDeleteOutline className="asset--delete--btn" onClick={() => deleteSavedCoin(index)} />
                    </td>
                  </tr>
                </tbody>
              )
