...
export const HighestHolding = ({ assets, balance }) => {
    ...
    useEffect(() => {
        ...
        setHighestTotal(parseInt(highestAssetTotal));
        setHighestName(highestAsset ? highestAsset.name : null);
        setImg(highestAsset ? highestAsset.img : null);
    }, [assets]);
